...
init_prop_ids(struct drmstate* drm)
{
    ...
    // connector
    {
        drmModeObjectPropertiesPtr props = drmModeObjectGetProperties(
          drm->fd, drm->conn_id, DRM_MODE_OBJECT_CONNECTOR);
        if (!props) {
        ...
        {
            int v = get_prop_id(drm->fd, props, "CRTC_ID");
            if (v == -1) {
    ...
    {
        drmModeObjectPropertiesPtr props = drmModeObjectGetProperties(
          drm->fd, drm->crtc_id, DRM_MODE_OBJECT_CRTC);
        if (!props) {
        ...
        {
            int v = get_prop_id(drm->fd, props, "ACTIVE");
            if (v == -1) {
        ...
        {
            int v = get_prop_id(drm->fd, props, "MODE_ID");
            if (v == -1) {
    ...
    {
        drmModeObjectPropertiesPtr props = drmModeObjectGetProperties(
          drm->fd, drm->plane_id, DRM_MODE_OBJECT_PLANE);
        if (!props) {
        ...
        {
            int v = get_prop_id(drm->fd, props, "SRC_X");
            if (v == -1) {
        ...
        {
            int v = get_prop_id(drm->fd, props, "SRC_Y");
            if (v == -1) {
        ...
        {
            int v = get_prop_id(drm->fd, props, "SRC_W");
            if (v == -1) {
        ...
        {
            int v = get_prop_id(drm->fd, props, "SRC_H");
            if (v == -1) {
        ...
        {
            int v = get_prop_id(drm->fd, props, "CRTC_X");
            if (v == -1) {
        ...
        {
            int v = get_prop_id(drm->fd, props, "CRTC_Y");
            if (v == -1) {
        ...
        {
            int v = get_prop_id(drm->fd, props, "CRTC_W");
            if (v == -1) {
        ...
        {
            int v = get_prop_id(drm->fd, props, "CRTC_H");
            if (v == -1) {
        ...
        {
            int v = get_prop_id(drm->fd, props, "FB_ID");
            if (v == -1) {
